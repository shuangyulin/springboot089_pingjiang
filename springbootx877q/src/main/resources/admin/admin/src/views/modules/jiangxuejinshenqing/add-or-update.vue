<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申请要求" prop="shenqingyaoqiu">
          <el-input v-model="ruleForm.shenqingyaoqiu" 
              placeholder="申请要求" clearable  :readonly="ro.shenqingyaoqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申请要求" prop="shenqingyaoqiu">
              <el-input v-model="ruleForm.shenqingyaoqiu" 
                placeholder="申请要求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="奖学金金额" prop="jiangxuejinjine">
          <el-input v-model="ruleForm.jiangxuejinjine" 
              placeholder="奖学金金额" clearable  :readonly="ro.jiangxuejinjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="奖学金金额" prop="jiangxuejinjine">
              <el-input v-model="ruleForm.jiangxuejinjine" 
                placeholder="奖学金金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenqingyaoqiu = true;
          ...
          if(o=='jiangxuejinjine'){
            this.ruleForm.jiangxuejinjine = obj[o];
	    this.ro.jiangxuejinjine = true;
            continue;
          }
        }
      }
