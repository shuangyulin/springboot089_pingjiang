<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="好事名称" prop="haoshimingcheng">
          <el-input v-model="ruleForm.haoshimingcheng" 
              placeholder="好事名称" clearable  :readonly="ro.haoshimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="好事名称" prop="haoshimingcheng">
              <el-input v-model="ruleForm.haoshimingcheng" 
                placeholder="好事名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发生地点" prop="fashengdidian">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="证明日期" prop="zhengmingriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.zhengmingriqi" 
                type="date"
                placeholder="证明日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhengmingriqi" label="证明日期" prop="zhengmingriqi">
              <el-input v-model="ruleForm.zhengmingriqi" 
                placeholder="证明日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="证明人" prop="zhengmingren">
          <el-input v-model="ruleForm.zhengmingren" 
              placeholder="证明人" clearable  :readonly="ro.zhengmingren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="证明人" prop="zhengmingren">
              <el-input v-model="ruleForm.zhengmingren" 
                placeholder="证明人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='haoshimingcheng'){
            this.ruleForm.haoshimingcheng = obj[o];
	    this.ro.haoshimingcheng = true;
            continue;
          }
          if(o=='fengmian'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='fashengdidian'){
            this.ruleForm.fashengdidian = obj[o];
	    this.ro.fashengdidian = true;
            continue;
          }
          if(o=='zhengmingriqi'){
            this.ruleForm.zhengmingriqi = obj[o];
	    this.ro.zhengmingriqi = true;
            continue;
          }
          if(o=='zhengmingren'){
            this.ruleForm.zhengmingren = obj[o];
	    this.ro.zhengmingren = true;
            continue;
          }
          if(o=='xuehao'){
    ...
    info(id) {
      this.$http({
        url: `haorenhaoshizhengming/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `haorenhaoshizhengming/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.haorenhaoshizhengmingCrossAddOrUpdateFlag = false;
                  this.parent.search();
