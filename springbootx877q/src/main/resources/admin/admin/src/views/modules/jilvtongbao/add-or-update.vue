<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="通报名称" prop="tongbaomingcheng">
          <el-input v-model="ruleForm.tongbaomingcheng" 
              placeholder="通报名称" clearable  :readonly="ro.tongbaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="通报名称" prop="tongbaomingcheng">
              <el-input v-model="ruleForm.tongbaomingcheng" 
                placeholder="通报名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="违纪项" prop="weijixiang">
          <el-input v-model="ruleForm.weijixiang" 
              placeholder="违纪项" clearable  :readonly="ro.weijixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="违纪项" prop="weijixiang">
              <el-input v-model="ruleForm.weijixiang" 
                placeholder="违纪项" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="通报日期" prop="tongbaoriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.tongbaoriqi" 
                type="date"
                placeholder="通报日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tongbaoriqi" label="通报日期" prop="tongbaoriqi">
              <el-input v-model="ruleForm.tongbaoriqi" 
                placeholder="通报日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="综合素质扣分" prop="zonghesuzhikoufen">
          <el-input v-model="ruleForm.zonghesuzhikoufen" 
              placeholder="综合素质扣分" clearable  :readonly="ro.zonghesuzhikoufen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="综合素质扣分" prop="zonghesuzhikoufen">
              <el-input v-model="ruleForm.zonghesuzhikoufen" 
                placeholder="综合素质扣分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="违纪内容" prop="weijineirong">
          <el-input v-model="ruleForm.weijineirong" 
              placeholder="违纪内容" clearable  :readonly="ro.weijineirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="违纪内容" prop="weijineirong">
              <el-input v-model="ruleForm.weijineirong" 
                placeholder="违纪内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	tongbaomingcheng : false,
	weijixiang : false,
	tongbaoriqi : false,
	zonghesuzhikoufen : false,
	weijineirong : false,
	xuehao : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='tongbaomingcheng'){
            this.ruleForm.tongbaomingcheng = obj[o];
	    this.ro.tongbaomingcheng = true;
            continue;
          }
          if(o=='weijixiang'){
            this.ruleForm.weijixiang = obj[o];
	    this.ro.weijixiang = true;
            continue;
          }
          if(o=='tongbaoriqi'){
            this.ruleForm.tongbaoriqi = obj[o];
	    this.ro.tongbaoriqi = true;
            continue;
          }
          if(o=='zonghesuzhikoufen'){
            this.ruleForm.zonghesuzhikoufen = obj[o];
	    this.ro.zonghesuzhikoufen = true;
            continue;
          }
          if(o=='weijineirong'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jilvtongbao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jilvtongbaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
